...
def generate_demand(*scenarios):
    ...
    for scenario in scenarios:
        ...
        # bike availability -- 1 for available, 0 for unavailable
        ...
        for segment in scenario.trip_settings.get('segments'):
            ...
            orig_bike_trips = create_trips(scenario, segment, buffered_zones)
            ...
            distribute_trips(scenario, segment, orig_bike_trips, dest_size, bike_avail)
...
def create_trips(scenario, segment, buffered_zones):
    ...
    return orig_bike_trips


def distribute_trips(scenario, segment, orig_bike_trips, dest_size, bike_avail):
